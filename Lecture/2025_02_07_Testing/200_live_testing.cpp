...
void testIsEven( )
{
    cout << "adding some text for folks that happen to be reading this!" << endl;
    cout << "begin tests" << endl;
    assert( isEven( -2 ) == true );
    assert( isEven( -1 ) == false );
    cout << "passed the negative tests -2, -1" << endl;
    ...
    assert( isEven( 4 ) );
    assert( !isEven( 5 ) );
    cout << "passed the positive values" << endl;
